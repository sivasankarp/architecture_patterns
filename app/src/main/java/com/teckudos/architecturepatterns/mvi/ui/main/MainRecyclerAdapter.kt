...
/*
* DiffUtil have build in algorithm that calculates the updates when we submit new items to
* recyclerview the problem of using default diff util is it does those calculation on main thread
* AsyncListDiffer is extension on it which do this in background thread
* */
